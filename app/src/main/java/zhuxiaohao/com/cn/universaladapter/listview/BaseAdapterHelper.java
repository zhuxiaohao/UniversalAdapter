...
public class BaseAdapterHelper
{
	...
	{
		android.widget.TextView view = retrieveView(viewId);
		view.setText(value);
		return this;
	}
	 ...
	 * @return The BaseAdapterHelper for chaining.
	 */
	public BaseAdapterHelper setImageDrawable(int viewId, android.graphics.drawable.Drawable drawable)
	{
		ImageView view = retrieveView(viewId);
	...
	public BaseAdapterHelper setImageBuilder(int viewId,
			com.squareup.picasso.RequestCreator requestBuilder)
	{
		ImageView view = retrieveView(viewId);
	 ...
	 * times.
	 */
	public BaseAdapterHelper setImageBitmap(int viewId, android.graphics.Bitmap bitmap)
	{
		ImageView view = retrieveView(viewId);
	...
	public BaseAdapterHelper setAlpha(int viewId, float value)
	{
		...
		} else
		{
			...
			android.view.animation.AlphaAnimation alpha = new android.view.animation.AlphaAnimation(value, value);
			alpha.setDuration(0);
	...
	public BaseAdapterHelper setTypeface(int viewId, android.graphics.Typeface typeface)
	{
		android.widget.TextView view = retrieveView(viewId);
		view.setTypeface(typeface);
		view.setPaintFlags(view.getPaintFlags() | android.graphics.Paint.SUBPIXEL_TEXT_FLAG);
		return this;
	}
	 ...
	 * rendering.
	 */
	public BaseAdapterHelper setTypeface(android.graphics.Typeface typeface, int... viewIds)
	{
	...
	{
		android.widget.ProgressBar view = retrieveView(viewId);
	...
	{
		android.widget.RatingBar view = retrieveView(viewId);
	...
	{
		android.widget.Checkable view = (android.widget.Checkable) retrieveView(viewId);
	 ...
	 * @return The BaseAdapterHelper for chaining.
	 */
	public BaseAdapterHelper setAdapter(int viewId, android.widget.Adapter adapter)
	{
		android.widget.AdapterView view = retrieveView(viewId);
