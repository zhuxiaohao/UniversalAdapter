		...
		BaseAdapter
{
	...
	{
		this.data = data == null ? new java.util.ArrayList<T>() : new java.util.ArrayList<T>(data);
	...
	public BaseQuickAdapter(Context context, java.util.ArrayList<T> data,
	...
	private android.view.View createIndeterminateProgressView(android.view.View convertView,
			android.view.ViewGroup parent)
	{
		if (convertView == null)
		{
			android.widget.FrameLayout container = new android.widget.FrameLayout(context);
			container.setForegroundGravity(android.view.Gravity.CENTER);
	 ...
	 */
	protected abstract H getAdapterHelper(int position, android.view.View convertView,
			android.view.ViewGroup parent);
