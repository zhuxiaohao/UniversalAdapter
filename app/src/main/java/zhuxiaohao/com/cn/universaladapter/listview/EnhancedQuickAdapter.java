...
public abstract class EnhancedQuickAdapter<T> extends QuickAdapter<T> {
     ...
     */
    public EnhancedQuickAdapter(android.content.Context context, int layoutResId) {
     ...
     */
    public EnhancedQuickAdapter(android.content.Context context, int layoutResId, java.util.List<T> data) {
